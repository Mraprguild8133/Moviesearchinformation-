...
def index():
    ...
    try:
        ...
        return """
        <html>
            <head><title>Movie & TV Bot</title></head>
            <body>
                <h1>Movie & TV Telegram Bot</h1>
                <p>Bot is running! Dashboard template not found.</p>
                <p><a href="/api/stats">View Stats</a> | <a href="/health">Health Check</a></p>
            </body>
        </html>
        """
